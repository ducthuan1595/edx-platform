...
from .views import EnrollmentCourseDetailView, EnrollmentListView, EnrollmentView, EnrollmentCustomView
...
urlpatterns = patterns(
    ...
    url(r'enroll_courses$', EnrollmentCustomView.as_view(), name='enroll_courses'),
)
